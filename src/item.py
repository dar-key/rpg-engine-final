...
class Item:
    def __init__(
        ...
        if item_type not in ITEM_TYPES:
            raise ValueError(
                f"Invalid item_type '{item_type}'. Must be: {list(ITEM_TYPES.keys())}"
            )
    ...
    def __repr__(self) -> str:
        return (
            f"Item({self.name!r}, type={self.item_type}, "
...
DEFAULT_ITEMS: list[Item] = [
    ...
    Item(
        ...
        "weapon",
        price=60,
        description="Standard soldier issue.",
        rarity="uncommon",
        attack_effect=12,
        speed_effect=1,
    ),
    ...
    Item(
        ...
        "armor",
        price=25,
        description="Flexible, light protection.",
        rarity="common",
        hp_effect=15,
    ),
    Item(
        ...
        "armor",
        price=80,
        description="Solid mid-tier armor.",
        rarity="uncommon",
        hp_effect=30,
        speed_effect=-2,
    ),
    Item(
        ...
        "armor",
        price=200,
        description="Forged from dragon hide.",
        rarity="rare",
        hp_effect=60,
        speed_effect=-1,
    ),
